...
DATA_DIR = "/home/user/GSK/heyalan/Reid/data/Market-1501-v15.09.15"  # 例: "/data/Market-1501-v15.09.15"
MODEL_NAME = "/data/llm/AI-ModelScope/R-4B" # 例: "/data/llm/AI-ModelScope/R-4B"
BASE_URL = "http://localhost:8000/v1"

RUN_PHASE_1_LIST = False         # 阶段一：List-wise 基线扫描 
RUN_PHASE_2_TOUR = False    # 阶段二 A：Tournament 锦标赛扫描 
